...
/**
 * This file contain Seeren\Database\Test\Dao\MySql\DropDbMySqlDaoTest class
 *     __
 *    / /__ __ __ __ __ __
 *   / // // // // // // /
 *  /_// // // // // // /
...
/**
 * Class for test DropDbMySqlDao
 * 
 * @category Seeren
 * @package Database
 * @subpackage Test\Dao\MySql
 */
class DropDbMySqlDaoTest extends AbstractDaoTest
{
    ...
    {
       return (new ReflectionClass(DropDbMySqlDao::class))
       ->newInstanceArgs([]);
    }
     ...
     * @covers \Seeren\Database\Dao\MySql\DropDbMySqlDao::execute
     * @covers \Seeren\Database\Dao\MySql\DropDbMySqlDao::getSyntax
