...
/**
 * This file contain Seeren\Database\Test\Dao\MySql\UseDbMySqlDaoTest class
 *     __
 *    / /__ __ __ __ __ __
 *   / // // // // // // /
 *  /_// // // // // // /
...
/**
 * Class for test UseDbMySqlDao
 *
 * @category Seeren
 * @package Database
 * @subpackage Test\Dao\MySql
 */
class UseDbMySqlDaoTest extends AbstractDaoTest
{
    ...
    {
        return (new ReflectionClass(UseDbMySqlDao::class))
        ->newInstanceArgs([]);
    }
     ...
     * @covers \Seeren\Database\Dao\MySql\UseDbMySqlDao::execute
     * @covers \Seeren\Database\Dao\MySql\UseDbMySqlDao::getSyntax
     * @covers \Seeren\Database\Dao\MySql\UseDbMySqlDao::query
